...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<nav id="sidebarMenu"
				...
				<div class="sidebar-sticky pt-3">
					<ul class="nav flex-column">
						...
						<li class="nav-item">
							<a class="nav-link active" href="/board/listArticles.do">
			...
			<main role="main" class="col ml-sm-auto col-lg-10 px-md-4">
				<div
					class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
					<h1 class="h2">자유로운 경제이야기</h1>
				</div>
				<div>
<!-- 				이 공간에 게시판 -->
						<%-- include Nav.jsp --%>
	...
	<script>
		window.jQuery || document.write('<script src="/resources/js/jquery-3.6.0.js"><\/script>')
	</script>
